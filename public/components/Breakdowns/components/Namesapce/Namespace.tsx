...
export default class Namespace extends Component<NamespaceProps> {
  render() {
    return (
        <Basic type="namespace"  breakdown={getGroupBreakdown(this.props.breakdown)} range={this.props.range} clusterId={this.props.clusterId} showNormalSparkline={true} showAnomaly={false} />
    );
  }
}
