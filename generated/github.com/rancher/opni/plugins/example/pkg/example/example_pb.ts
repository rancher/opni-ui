...
// @generated from file github.com/rancher/opni/plugins/example/pkg/example/example.proto (package example, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message example.EchoRequest
 */
export class EchoRequest extends Message<EchoRequest> {
  ...
  static readonly typeName = "example.EchoRequest";
...
/**
 * @generated from message example.EchoResponse
 */
export class EchoResponse extends Message<EchoResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "example.EchoResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "message", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
